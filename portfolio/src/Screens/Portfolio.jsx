  ...
  return (
    <div className='portfolio-container'>
      <div className='proj-container'>
        <img src='https://i.imgur.com/cgZ15Kk.png' alt='pets-r-us' className='proj-img'></img>
      ...
      <div className='proj-container'>
        <img src='https://i.imgur.com/K51bRMa.png' alt='striva' className='proj-img'></img>
      ...
      <div className='proj-container'>
        <img src='https://i.imgur.com/86cSM8J.png' alt='avy-savvy' className='proj-img'></img>
